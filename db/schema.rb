...
ActiveRecord::Schema.define(version: 20211101204345) do
  ...
  create_table "technologies", force: :cascade do |t|
    ...
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.index ["portfolio_section_id"], name: "index_technologies_on_portfolio_section_id", using: :btree
  end
  ...
  add_foreign_key "technologies", "portfolio_sections"
end
